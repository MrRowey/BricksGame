...
namespace Bricks
{
    class Paddle
    {
        public float X { get; set; } // x postion of the paddle on the screen
        public float Y { get; set; } // y postion of the paddle on the screen
        ...
        private Texture2D imgPaddle { get; set; } //cached image if the paddle
